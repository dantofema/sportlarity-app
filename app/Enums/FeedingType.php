...
enum FeedingType: int
{
    ...
    public static function description(FeedingType $type): string
    {
        return match ($type) {
            self::WRONG => 'MAL',
    ...
    public static function color(FeedingType $type): string
    {
        return match ($type) {
            self::WRONG => 'danger',
    ...
    public static function icon(FeedingType $type): string
    {
        return match ($type) {

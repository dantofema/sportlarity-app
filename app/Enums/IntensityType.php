...
enum IntensityType: int
{
    ...
    public static function description(IntensityType $type): string
    {
        return match ($type) {
            self::REST => 'DESCANSO',
            self::LIGHT => 'LEVE',
    ...
    public static function color(IntensityType $type): string
    {
        return match ($type) {
            self::REST => 'success',
            self::LIGHT => 'info',
    ...
    public static function icon(IntensityType $type): string
    {
        return match ($type) {

...
<div style="display: flex; align-items: center; justify-content: center; flex-direction: column; margin-top: 1.25rem; font-family : Nunito, sans-serif ">
    <section style="max-width: 42rem; background-color: #fff;">
        ...
        <main style="text-align : start; padding-left : 20px; padding-right : 20px;">
            <p>
                Hola <span style="font-weight : bold;">{{ $user->name }}</span>.
                ¡Nos alegra que estés aquí!
            </p>

            <p style="margin-top : 10px;">
                Te estás uniendo a la comunidad de
                <span style="font-weight: bold;">Sportlarity</span>.
                Serás el primero en enterarte de actualizaciones sobre nuevos
                entrenamientos, noticias y mucho
                más.
                Si está interesado en obtener más información sobre Sportlarity
                no dudes en comunicarte con
                nuestro equipo de profesionales en cualquier momento.
                Siempre estamos aquí para ayudarte en todo lo que podamos.
            </p>
